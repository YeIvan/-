...
<TABLE width="70%" border=0 align="center" cellPadding=5 cellSpacing=1 bgColor=#336699>
 <form name="form10" action="save_smallclass.php?act=add" method="post">
  ...
  <TR class=tr_southidc>
    ...
    <TD width="16%" align="center" bgColor=#336699><span class="STYLE14">是否需要回复</span></TD>
...
?>
  <TR class=tr_southidc>
    <TD height=28 align="center" bgColor=#ecf5ff><a href="book_info.php?id=<?=$rs["book_id"]?>">详细</a></TD>
