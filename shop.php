      ...
      <tr>
        <td height="35" background="images/lm1.jpg"><table width="97%" height="24" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="85%" align="left" valign="middle" class="hei14">店铺展示</td>
...
$nextpage=$page+1;
$prepage=$page-1;
$exec=$sql." order by sh_id desc limit ".($page*$pagesize).",$pagesize"; 
...
?>
		...
		?>
              <td height="185" align="center" valign="middle"><table width="89%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td height="162" align="center" valign="middle"><a href="show_shop.php?id=<?=$arryid[$t]?>"><img src="<?=$arryimg[$t]?>" width="193" height="153" border="0" /></a></td>
                  </tr>
                  <tr>
          <td height="23" align="center"><a href="show_shop.php?id=<?=$arryid[$t]?>" class="text12"><?=left($arry[$t],10)?> </a>   <a href="sc.php?act=add&id=<?=$arryid[$t]?>"><span class="STYLE2">关注</span></a></td>
                  </tr>
              </table></td>
                <?
