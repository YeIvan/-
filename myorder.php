      ...
      <tr>
        <td height="406" align="center" valign="middle"><table width="98%" height="53" border="0" class="border">
          <tr>
            ...
            <td width="17%" align="center" class="text12">下单时间</td>
            <td width="28%" align="center" class="text12">交易商品</td>
            <td width="8%" align="center" class="text12">数量</td>
            <td width="11%" align="center" class="text12">处理状态</td>
            <td width="11%" align="center" class="text12">&nbsp;</td>
          </tr>
          <?
			$hy_id=$_SESSION["hy_id"];
			$sql="select * from shop_order where hy_id='$hy_id'";
          ...
          <tr>
            ...
            <td align="center" class="text12"><?=$rst["order_num"]?></td>
            <td align="center" class="text12"><?=$rst["order_state"]?></td>
            <td align="center"><a href="ts.php?order_id=<?=$rst["order_id"]?>" class="text12">纠纷投诉</a></td>
          </tr>
          <?
			}
