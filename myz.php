    ...
    <td align="left" valign="top"><table width="100%" height="485" border="0" cellpadding="0" cellspacing="0" class="border">
      ...
      <tr>
        <td height="448" align="center" valign="middle"><table width="97%" border="0">
          <tr>
            <td width="15%" height="25" align="center" bgcolor="#E3F6FC">姓名</td>
            <td width="15%" align="center" bgcolor="#E3F6FC">帐号</td>
            <td width="12%" align="center" bgcolor="#E3F6FC">性别</td>
            <td width="31%" align="center" bgcolor="#E3F6FC">标题</td>
            <td width="14%" align="center" bgcolor="#E3F6FC">价格</td>
            <td align="center" bgcolor="#E3F6FC">状态</td>
            </tr>
          <?
		  $hy_id=$_SESSION["hy_id"];
		  $q=mysqli_query($conn,"select * from orders where hy_id='$hy_id'");
          ...
          <tr>
            ...
            <td height="31" align="center"><?=$rs["title"]?>            </td>
            <td height="31" align="center"><?=$rs["price"]?>元</td>
            <td width="13%" height="31" align="center"><?=$rs["state"]?></td>
            </tr>
          <?
		  }
